...
def maze_choice():
	...
	if data.condition is maze_a_pressed:
		...
		choice_box.remove(); yield phase_choice()
		maze_root = 'C:\Users\matthew\Desktop\server pull - 2-2 (SNAP)\SNAPMazeC'; start_coords = (100,0,-47); start_ori = (90,0,0); end_coords = (640,750,2080,2120)
	elif data.condition is maze_d_pressed:
		choice_box.remove(); yield phase_choice()
		maze_root = 'C:\Users\matthew\Desktop\server pull - 2-2 (SNAP)\SNAPMazeD'; start_coords = (414,0,285); start_ori = (0,0,0); end_coords = (550,575,1100,1200)
	choice_box.remove()
...
def run_condition_two():
	...
	elif maze_root == 'C:\Users\matthew\Desktop\server pull - 2-2 (SNAP)\SNAPMazeC':
		#setup start location dictionary {Start Location:((Start Coordinates),(Start Orientation)),...}
	...
	elif maze_root == 'C:\Users\matthew\Desktop\server pull - 2-2 (SNAP)\SNAPMazeD':
		#setup start location dictionary {Start Location:((Start Coordinates),(Start Orientation)),...}
