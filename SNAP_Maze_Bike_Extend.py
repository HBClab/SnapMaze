...
def task_choice():
	...
	while True:
		...
		if data.condition is condition_one_pressed:
			...
			maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\PMS'; start_coords = (0,40,0); start_ori = (3.5,0,0);
			yield practice_maze(); yield task_choice()
		elif data.condition is expertise_pressed:
			viz.mouse(viz.OFF); viz.mouse.setVisible(viz.OFF)
			maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\VMS'; start_coords = (0,40,0); start_ori = (0,0,0); end_coords = [1150,1275,-190,-100];
...
def maze_choice():
	...
	if data.condition is maze_a_pressed:
		...
		maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\SNAPMazeA'; start_coords = (0,40,0); start_ori = (0,0,0); end_coords = (-745,-700,2125,2180)
	elif data.condition is maze_b_pressed:
		choice_box.remove(); yield phase_choice()
		maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\SNAPMazeB'; start_coords = (-1114,40,2151); start_ori = (-180,0,0); end_coords = (-1876,-1795,115,156)
	elif data.condition is maze_c_pressed:
		choice_box.remove(); yield phase_choice()
		maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\SNAPMazeC'; start_coords = (100,0,-47); start_ori = (90,0,0); end_coords = (640,750,2080,2120)
	elif data.condition is maze_d_pressed:
		choice_box.remove(); yield phase_choice()
		maze_root = 'C:\Experiments\Bike_Extend_Pilot\SNAP\SNAPMazeD'; start_coords = (414,0,285); start_ori = (0,0,0); end_coords = (550,575,1100,1200)
	choice_box.remove()
...
def run_condition_two():
	...
	if maze_root == 'C:\Experiments\Bike_Extend_Pilot\SNAP\SNAPMazeA':
		...
		#setup start location dictionary {Start Location:((Start Coordinates),(Start Orientation)),...}
		start_dic = {'A': ((788,0,110),(0,0,0)), 'B': ((2064,0,995),(180,0,0)), 'C': ((110,0,1050),(90,0,0)), 'D': ((100,0,-47),(90,0,0)), 'E': ((700,0,2100),(180,0,0)), 'F': ((950,0,1714),(90,0,0))}
		#setup object list (Object,Start Location,End Coordinates)
		...
		#setup start location dictionary {Start Location:((Start Coordinates),(Start Orientation)),...}
		start_dic = {'A': ((1395,0,1795),(90,0,0)), 'B': ((2060,0,316),(0,0,0)), 'C': ((1145,0,211),(0,0,0)), 'D': ((414,0,285),(0,0,0)), 'E': ((560,0,1150),(90,0,0)), 'F': ((1130,0,1070),(90,0,0))}
		#setup object list (Object,Start Location,End Coordinates)
...
def write_trial_data():	
	...
	#Open output file
	file = open('C:\Experiments\Bike_Extend_Pilot\SNAP\\' + str(subject_id_data) + '.txt' ,'a')
