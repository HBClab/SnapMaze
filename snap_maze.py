...
def task_choice():
    ...
    while True:
        ...
        if data.condition is condition_one_pressed:
            ...
            maze_root = 'C:\Experiments\AMBI2016\SNAP\Programs_Environments\\SNAP\Programs_Environments\PMS'
            start_coords = (0, 40, 0)
            start_ori = (3.5, 0, 0)
            yield practice_maze()
            yield task_choice()
            ...
            viz.mouse(viz.OFF)
            viz.mouse.setVisible(viz.OFF)
            maze_root = 'C:\Experiments\AMBI2016\SNAP\Programs_Environments\VMS'
            start_coords = (0, 40, 0)
            start_ori = (0, 0, 0)
...
def maze_choice():
    ...
    if data.condition is maze_a_pressed:
        choice_box.remove()
        yield phase_choice()
        maze_root = 'C:\Experiments\AMBI2016\SNAP\Programs_Environments\SNAPMazeA'
        start_coords = (0, 40, 0)
        start_ori = (0, 0, 0)
        ...
        choice_box.remove()
        yield phase_choice()
        maze_root = 'C:\Experiments\AMBI2016\SNAP\Programs_Environments\SNAPMazeB'
...
def write_trial_data():
    ...
    # Open output file
    file = open('C:\Experiments\AMBI2016\SNAP\Programs_Environments\\' +
